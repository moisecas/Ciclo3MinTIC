...
public class ControllerFull {
    ...
    public String movimientosPorEmpleado(@PathVariable("id")Integer id, Model model){ //Filtrar los movimientos por empleado
        ArrayList<MovimientoDinero> movlist = movimientosService.obtenerPorEmpleado(id);
